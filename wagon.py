...
def _add_create_command(parser):
    ...
    command.add_argument(
        ...
        required=False,
        action='append',
        help='Path to the venvs that the pip will be taken from.'
             'This argument can be provided multiple times')
